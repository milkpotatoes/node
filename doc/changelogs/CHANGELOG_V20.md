...
* \[[`65d0160b42`](https://github.com/nodejs/node/commit/65d0160b42)] - **fs**: add c++ fast path for writeFileSync utf8 (CanadaHonk) [#49884](https://github.com/nodejs/node/pull/49884)
...
* \[[`95481dce4c`](https://github.com/nodejs/node/commit/95481dce4c)] - **benchmark**: update iterations in benchmark/util/splice-one.js (Liu Jia) [#50698](https://github.com/nodejs/node/pull/50698)
...
* \[[`44081d8a24`](https://github.com/nodejs/node/commit/44081d8a24)] - **build**: add GN configurations for simdjson (Cheng Zhao) [#50831](https://github.com/nodejs/node/pull/50831)
...
* \[[`243c81fb81`](https://github.com/nodejs/node/commit/243c81fb81)] - **crypto**: update root certificates to NSS 3.95 (Node.js GitHub Bot) [#50805](https://github.com/nodejs/node/pull/50805)
* \[[`fd4149d8a4`](https://github.com/nodejs/node/commit/fd4149d8a4)] - **deps**: update zlib to 1.2.13.1-motley-5daffc7 (Node.js GitHub Bot) [#50803](https://github.com/nodejs/node/pull/50803)
* \[[`22476f4635`](https://github.com/nodejs/node/commit/22476f4635)] - **deps**: update undici to 5.27.2 (Node.js GitHub Bot) [#50813](https://github.com/nodejs/node/pull/50813)
* \[[`e2aa879ce1`](https://github.com/nodejs/node/commit/e2aa879ce1)] - **deps**: V8: cherry-pick 0f9ebbc672c7 (Chengzhong Wu) [#50867](https://github.com/nodejs/node/pull/50867)
* \[[`83f12946a8`](https://github.com/nodejs/node/commit/83f12946a8)] - **deps**: V8: cherry-pick 13192d6e10fa (Levi Zim) [#50552](https://github.com/nodejs/node/pull/50552)
* \[[`6e196d41b7`](https://github.com/nodejs/node/commit/6e196d41b7)] - **deps**: update zlib to 1.2.13.1-motley-dfc48fc (Node.js GitHub Bot) [#50456](https://github.com/nodejs/node/pull/50456)
* \[[`14621418a9`](https://github.com/nodejs/node/commit/14621418a9)] - **deps**: update llhttp to 9.1.3 (Node.js GitHub Bot) [#50080](https://github.com/nodejs/node/pull/50080)
...
* \[[`d8dfacfdf5`](https://github.com/nodejs/node/commit/d8dfacfdf5)] - **doc**: recommend supported Python versions (Luigi Pinca) [#50407](https://github.com/nodejs/node/pull/50407)
* \[[`f7c18f3c03`](https://github.com/nodejs/node/commit/f7c18f3c03)] - **doc**: update notable changes in v21.1.0 (Joyee Cheung) [#50388](https://github.com/nodejs/node/pull/50388)
* \[[`89252362ce`](https://github.com/nodejs/node/commit/89252362ce)] - **doc**: make theme consistent across api and other docs (Dima Demakov) [#50877](https://github.com/nodejs/node/pull/50877)
* \[[`f3c75ad527`](https://github.com/nodejs/node/commit/f3c75ad527)] - **doc**: add a section regarding `instanceof` in `primordials.md` (Antoine du Hamel) [#50874](https://github.com/nodejs/node/pull/50874)
* \[[`af5b726ca7`](https://github.com/nodejs/node/commit/af5b726ca7)] - **doc**: update email to reflect affiliation (Yagiz Nizipli) [#50856](https://github.com/nodejs/node/pull/50856)
* \[[`c72f607e37`](https://github.com/nodejs/node/commit/c72f607e37)] - **doc**: shard not supported with watch mode (Pulkit Gupta) [#50640](https://github.com/nodejs/node/pull/50640)
* \[[`84a6658c0e`](https://github.com/nodejs/node/commit/84a6658c0e)] - **doc**: get rid of unnecessary `eslint-skip` comments (Antoine du Hamel) [#50829](https://github.com/nodejs/node/pull/50829)
* \[[`e5b6ca1060`](https://github.com/nodejs/node/commit/e5b6ca1060)] - **doc**: create deprecation code for isWebAssemblyCompiledModule (Marco Ippolito) [#50486](https://github.com/nodejs/node/pull/50486)
* \[[`033c4827d6`](https://github.com/nodejs/node/commit/033c4827d6)] - **doc**: add CanadaHonk to triagers (CanadaHonk) [#50848](https://github.com/nodejs/node/pull/50848)
* \[[`ae78606f3b`](https://github.com/nodejs/node/commit/ae78606f3b)] - **doc**: fix typos in --allow-fs-\* (Tobias Nießen) [#50845](https://github.com/nodejs/node/pull/50845)
...
* \[[`fbdf291bb9`](https://github.com/nodejs/node/commit/fbdf291bb9)] - **esm**: fallback to `getSource` when `load` returns nullish `source` (Antoine du Hamel) [#50825](https://github.com/nodejs/node/pull/50825)
* \[[`7c386fa460`](https://github.com/nodejs/node/commit/7c386fa460)] - **esm**: do not call `getSource` when format is `commonjs` (Francesco Trotta) [#50465](https://github.com/nodejs/node/pull/50465)
...
* \[[`c1a196c897`](https://github.com/nodejs/node/commit/c1a196c897)] - **(SEMVER-MINOR)** **esm**: add import.meta.dirname and import.meta.filename (James Sumners) [#48740](https://github.com/nodejs/node/pull/48740)
* \[[`65d0160b42`](https://github.com/nodejs/node/commit/65d0160b42)] - **fs**: add c++ fast path for writeFileSync utf8 (CanadaHonk) [#49884](https://github.com/nodejs/node/pull/49884)
* \[[`900d4486fd`](https://github.com/nodejs/node/commit/900d4486fd)] - **fs**: improve error perf of sync `lstat`+`fstat` (CanadaHonk) [#49868](https://github.com/nodejs/node/pull/49868)
* \[[`cb55d04213`](https://github.com/nodejs/node/commit/cb55d04213)] - **fs**: improve error performance for `rmdirSync` (CanadaHonk) [#49846](https://github.com/nodejs/node/pull/49846)
* \[[`986183bd08`](https://github.com/nodejs/node/commit/986183bd08)] - **fs**: fix to not return for void function (Jungku Lee) [#50769](https://github.com/nodejs/node/pull/50769)
* \[[`1c0b221560`](https://github.com/nodejs/node/commit/1c0b221560)] - **fs**: replace deprecated `path._makeLong` in copyFile (CanadaHonk) [#50844](https://github.com/nodejs/node/pull/50844)
...
* \[[`b6772187f7`](https://github.com/nodejs/node/commit/b6772187f7)] - **lib**: use primordials for navigator.userAgent (Aras Abbasi) [#50467](https://github.com/nodejs/node/pull/50467)
...
* \[[`ba6d3653e7`](https://github.com/nodejs/node/commit/ba6d3653e7)] - **meta**: clarify nomination process according to Node.js charter (Matteo Collina) [#50834](https://github.com/nodejs/node/pull/50834)
* \[[`b75770eb91`](https://github.com/nodejs/node/commit/b75770eb91)] - **meta**: clarify recommendation for bug reproductions (Antoine du Hamel) [#50882](https://github.com/nodejs/node/pull/50882)
* \[[`e61977e8f0`](https://github.com/nodejs/node/commit/e61977e8f0)] - **meta**: move cjihrig to TSC regular member (Colin Ihrig) [#50816](https://github.com/nodejs/node/pull/50816)
...
* \[[`420c15791c`](https://github.com/nodejs/node/commit/420c15791c)] - **permission**: do not create symlinks if target is relative (Tobias Nießen) [#49156](https://github.com/nodejs/node/pull/49156)
...
* \[[`8811eca25d`](https://github.com/nodejs/node/commit/8811eca25d)] - **src**: assert return value of BN\_bn2binpad (Tobias Nießen) [#50860](https://github.com/nodejs/node/pull/50860)
* \[[`f79b9f898c`](https://github.com/nodejs/node/commit/f79b9f898c)] - **src**: fix coverity warning (Michael Dawson) [#50846](https://github.com/nodejs/node/pull/50846)
* \[[`75aa77fbae`](https://github.com/nodejs/node/commit/75aa77fbae)] - **src**: fix compatility with upcoming V8 12.1 APIs (Cheng Zhao) [#50709](https://github.com/nodejs/node/pull/50709)
* \[[`c04e0034b0`](https://github.com/nodejs/node/commit/c04e0034b0)] - **(SEMVER-MINOR)** **src**: add `--disable-warning` option (Ethan Arrowood) [#50661](https://github.com/nodejs/node/pull/50661)
...
* \[[`e013c5cefc`](https://github.com/nodejs/node/commit/e013c5cefc)] - **stream**: fix enumerability of ReadableStream.from (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`72f121e393`](https://github.com/nodejs/node/commit/72f121e393)] - **stream**: fix enumerability of ReadableStream.prototype.values (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`1aec6f68c7`](https://github.com/nodejs/node/commit/1aec6f68c7)] - **stream**: add Symbol.toStringTag to Compression Streams (Filip Skokan) [#50712](https://github.com/nodejs/node/pull/50712)
...
* \[[`844f0568fa`](https://github.com/nodejs/node/commit/844f0568fa)] - **test**: fix message v8 not normalising alphanumeric paths (Jithil P Ponnan) [#50730](https://github.com/nodejs/node/pull/50730)
* \[[`6be9344ba0`](https://github.com/nodejs/node/commit/6be9344ba0)] - **test**: fix dns test case failures after c-ares update to 1.21.0+ (Brad House) [#50743](https://github.com/nodejs/node/pull/50743)
* \[[`eb10c25c0b`](https://github.com/nodejs/node/commit/eb10c25c0b)] - **test**: replace forEach with for of (Conor Watson) [#50594](https://github.com/nodejs/node/pull/50594)
* \[[`04717bdb62`](https://github.com/nodejs/node/commit/04717bdb62)] - **test**: replace forEach to for at test-webcrypto-sign-verify-ecdsa.js (Alessandro Di Nisio) [#50795](https://github.com/nodejs/node/pull/50795)
* \[[`622cf681ad`](https://github.com/nodejs/node/commit/622cf681ad)] - **test**: replace foreach with for in test-https-simple.js (Shikha Mehta) [#49793](https://github.com/nodejs/node/pull/49793)
...
* \[[`32ad208155`](https://github.com/nodejs/node/commit/32ad208155)] - **tools**: add macOS notarization verification step (Ulises Gascón) [#50833](https://github.com/nodejs/node/pull/50833)
* \[[`aa74680bb8`](https://github.com/nodejs/node/commit/aa74680bb8)] - **tools**: use macOS keychain to notarize the releases (Ulises Gascón) [#50715](https://github.com/nodejs/node/pull/50715)
...
* \[[`68375ef4a7`](https://github.com/nodejs/node/commit/68375ef4a7)] - **v8,tools**: expose necessary V8 defines (Cheng Zhao) [#50820](https://github.com/nodejs/node/pull/50820)
